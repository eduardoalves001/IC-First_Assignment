...
![Figure 1](singleecho.png)
*Figure 1: The audio sample before and after applying an echo effect with a 250 ms delay and 0.4 feedback.*

![Figure 2](multiecho.png)
*Figure 2: The audio sample before and after applying an multiecho effect with a 100 ms delay and 0.3 feedback, 200ms and 0.2 feedback and 300ms and 0.1 feedback.*

![Figure 3](amplitudemodulation.png)
*Figure 3: The audio sample before and after applying an amplitude modulation effect with a 5 Hz frequency and 0.5 depth.*

![Figure 4](timevar.png)
*Figure 4: The audio sample before and after applying a time-varying delay with a 10 ms base delay, 1.5 Hz modulation frequency, 5 ms modulation depth, 0.3 feedback, and 0.5 wet/dry mix*

![Figure 5](ringmod.png)
*Figure 5: The audio sample before and after applying a ring modulation effect using a 440 Hz carrier frequency.*

![Figure 6](distorsion.png)
*Figure 6: The audio sample before and after applying a distortion effect using a gain of 2 and a threshold of 0.7.*

![Figure 7](reverse.png)
*Figure 7: The audio sample before and after applying the reverse effect.*

![Figure 8](fadein.png)
*Figure 8: The audio sample before and after applying a fade-in effect over 500ms.*