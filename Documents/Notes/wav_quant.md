...
_Figure 1: Gnuplot histogram of a audio file processed with 8-bit uniform scalar quantization_

![Figure 2](../Images/4.png)
_Figure 2: Gnuplot histogram of a audio file processed with 4-bit uniform scalar quantization_

![Figure 3](../Images/2.png)
_Figure 2: Gnuplot histogram of a audio file processed with 2-bit uniform scalar quantization_
